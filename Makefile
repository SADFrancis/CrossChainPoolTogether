...
# to send 70 see command below:
# $ make fund-link AMOUNT=70
fund-link:
...
cross-chain-usdc-approve:
	cast send $(DEPLOYED_SOURCE_USDC_SENDER) "crossChainApproval(uint64,address,uint256,bool)" $(DESTINATION_CHAIN_SELECTOR) $(DEPLOYED_DESTINATION_RECEIVER) $(USDC_AMOUNT) true --rpc-url $(SOURCE_RPC_URL) 
